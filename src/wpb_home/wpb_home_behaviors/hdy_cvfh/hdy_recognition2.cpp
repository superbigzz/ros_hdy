...
void parseCommandLine (int argc, char *argv[])
{
  ...
  {
    showHelp (argv[0]);//argv[0]程序的名称，并且包含了程序所在的完整路径。
    exit (0);
  }
...
int main (int argc, char *argv[])
{
  ...
  norm_est.setNumberOfThreads(4);   //手动设置线程数，pcl::NormaleEstimationOMP，使用多核/多线程开发规范，提速方法，100%兼容pcl::NormalEstimation
  ...
  pcl::VFHEstimationPointType, NormalType, DescriptorType> descr_est;
