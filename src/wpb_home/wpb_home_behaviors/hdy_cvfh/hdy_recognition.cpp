...
int main (int argc, char** argv)
{
  ...
  std::string kdtree_idx_file_name = "/home/hdy/Documents/hdy_pcl/hdy_train/kdtree.idx";
  std::string training_data_h5_file_name = "/home/hdy/Documents/hdy_pcl/hdy_train/training_data.h5";
  std::string training_data_list_file_name = "/home/hdy/Documents/hdy_pcl/hdy_train/training_data.list";
  ...
  if (!boost::filesystem::exists ("training_data.h5") || !boost::filesystem::exists ("/home/hdy/Documents/hdy_pcl/hdy_train/training_data.list"))
  {
  ...
  { 
    flann::Index<flann::ChiSquareDistance<float> > index (data, flann::SavedIndexParams ("/home/hdy/Documents/hdy_pcl/hdy_train/kdtree.idx"));
    pcl::console::print_info (" tree index has already been saved to disk\n"); 
    index.buildIndex ();
  ...
  for (int i = 0; i < k; ++i)
  {
    ...
    pcl::console::print_info ("before error"); 
    ...
    pcl::PCLPointCloud2 cloud;
    pcl::PointCloud<PointT> cloud_xyz;
    //pcl::console::print_highlight (stderr, "Loading "); pcl::console::print_value (stderr, "%s ", cloud_name.c_str ());
    //if (pcl::io::loadPCDFile (cloud_name, cloud_xyz) == -1)
      //break;
    
    pcl::io::loadPCDFile (cloud_name, cloud_xyz);
    pcl::console::print_info ("after error");
   ...
   // pcl::fromPCLPointCloud2(cloud, cloud_xyz);
    ...
    pcl::PointCloud<PointT>::Ptr cloud_xyz_demean (new pcl::PointCloud<PointT>);
    pcl::demeanPointCloud<PointT> (cloud_xyz, centroid, *cloud_xyz_demean);
    // Add to renderer*
