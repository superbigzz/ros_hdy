 ...
 */
  ...
  std::vector<vfh_model> models;
  std::string filepath = "/home/hdy/Documents/hdy_pcl/hdy_models";
  boost::filesystem::path modelpath(filepath);
  boost::filesystem::path trainpath("/home/hdy/Documents/hdy_pcl/hdy_train");
  // Load the model histograms
  loadFeatureModels (modelpath, extension, models);
  ...
  ROS_INFO("Convert data into FLANN format");
  ...
  ROS_INFO("Build the tree index and save it to disk");
  index.buildIndex ();
