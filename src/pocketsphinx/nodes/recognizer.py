...
class recognizer(object):
    ...
    def __init__(self):
        ...
        print"Configure mics with gstreamer launch config"
    ...
    def start_recognizer(self):
        ...
        print"Configure language model"
        if rospy.has_param(self._lm_param):
            lm = rospy.get_param(self._lm_param)
            print"rospy.has_param"
        else:
        ...
        #self.asr.set_property('lm', '/home/hdy/catkin_ws/src/wpb_home/wpb_home_tutorials/sr/hdy/hdy.lm')
        #self.asr.set_property('dict', '/home/hdy/catkin_ws/src/wpb_home/wpb_home_tutorials/sr/hdy/hdy.dic')
        #self.asr.set_property('hmm', '/home/hdy/catkin_ws/src/wpb_home/wpb_home_tutorials//sr/zh_cn.cd_cont_5000')
